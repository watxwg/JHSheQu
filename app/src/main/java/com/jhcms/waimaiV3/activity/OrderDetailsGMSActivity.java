...
import com.jhcms.common.utils.SphericalUtil;
...
public class OrderDetailsGMSActivity extends AppCompatActivity implements OnRequestSuccessCallback, OnMapReadyCallback, GoogleMap.InfoWindowAdapter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobclickAgent.setScenarioType(OrderDetailsGMSActivity.this, MobclickAgent.EScenarioType.E_UM_NORMAL);
...
//        location();
    ...
    private void RequestData() {
        try {
            ...
            HttpUtils.postUrl(this, Api.WAIMAI_ORDER_DETAIL, str, false, this);
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    ...
    private void GO_ORDER() {
        Intent intent = new Intent(OrderDetailsGMSActivity.this, WaiMaiMainActivity.class);
    ...
    private void initOrderMap(Response_Orederdetail mdata) {
        staff = mdata.getData().getDetail().getStaff();
    ...
    private void addMarkersToMap(LatLng latLng) {
        ...
        /*LatLng UserLatLng = new LatLng(userLatlng.latitude, userLatlng.longitude);
    ...
    public void onClick(View view) {
        ...
        switch (view.getId()) {
            case R.id.stv_one:
                /*去支付*/
                Intent intent = new Intent(OrderDetailsGMSActivity.this, ToPayActivity.class);
            ...
            case R.id.StvSeven://TODO 查看网页评价
                Intent i2 = new Intent(OrderDetailsGMSActivity.this, LookMerchantEvaluationActivity.class);
            ...
            case R.id.StvEight://TODO 去评价
                ...
                Intent i = new Intent(OrderDetailsGMSActivity.this, MerchantEvaluationActivity.class);
...
//                ToastUtil.show("配送员电话");
            ...
            case R.id.ll_shop_name:
                intent3.setClass(OrderDetailsGMSActivity.this, WaiMaiShopActivity.class);
            ...
            case R.id.iv_complain://TODO 投诉
                if (mData.getData().getDetail().getComplaint().equals("0")) {
                    Intent intent4 = new Intent(OrderDetailsGMSActivity.this, ComplainActivity.class);
            ...
            case R.id.tv_order_status:
                Intent intent5 = new Intent(OrderDetailsGMSActivity.this, WebViewActivity.class);
    ...
    private void inintmZiTiMaPopuwindow() {
        View view = LayoutInflater.from(OrderDetailsGMSActivity.this).inflate(R.layout.waimai_order_zitima_layout, null);
    ...
    private void ShopCreatOrder() {
        ...
        Intent intent = new Intent(OrderDetailsGMSActivity.this, WaiMaiShopActivity.class);
    ...
    private void showPopuwindowrefund() {
        final OrderCancelDialog diaglog = new OrderCancelDialog(OrderDetailsGMSActivity.this);
        diaglog.setOnClickListener(new OrderCancelDialog.OnClickListener() {
            ...
            public void clickListener(String content) {
                ...
                try {
                    ...
                    String str = js.toString();
                    HttpUtils.postUrl(OrderDetailsGMSActivity.this, Api.WAIMAI_ORDER_PAYBACK, str, true, new OnRequestSuccessCallback() {
                        @Override
    ...
    private void orderConfirm() {
        TipDialog Confirmdialog = new TipDialog(OrderDetailsGMSActivity.this, new TipDialog.setTipDialogCilck() {
            @Override
            public void setPositiveListener() {
                try {
                    ...
                    js.put("order_id", mData.getData().getDetail().getOrder_id());
                    String str = js.toString();
                    HttpUtils.postUrl(OrderDetailsGMSActivity.this, Api.WAIMAI_ORDER_CONFRIM, str, true, new OnRequestSuccessCallback() {
                        @Override
                        public void onSuccess(String url, String Json) {
    ...
    private void callkefu(final Data_Orederdetail data) {
        TipDialog kefudialog = new TipDialog(OrderDetailsGMSActivity.this, new TipDialog.setTipDialogCilck() {
            @Override
            public void setPositiveListener() {
                try {
                    JSONObject js = new JSONObject();
                    ...
                    String str = js.toString();
                    HttpUtils.postUrl(OrderDetailsGMSActivity.this, Api.WAIMAI_ORDER_KEFU, str, true, new OnRequestSuccessCallback() {
                        @Override
                        public void onSuccess(String url, String Json) {
    ...
    private void CancelOrder(final String order_id) {
        TipDialog canceldialog = new TipDialog(OrderDetailsGMSActivity.this, new TipDialog.setTipDialogCilck() {
            @Override
            public void setPositiveListener() {
                ...
                try {
                    ...
                    js.put("order_id", order_id);
                    String str = js.toString();
                    HttpUtils.postUrl(OrderDetailsGMSActivity.this, Api.WAIMAI_ORDER_CHARGEBACK, str, true, new OnRequestSuccessCallback() {
                        @Override
                        public void onSuccess(String url, String Json) {
    ...
    private void inintYouhuiList(ArrayList<YouHuiModel> youhui) {
        madapter = new OrderDetailsActivityYouHuiAdapter(OrderDetailsGMSActivity.this, youhui);
...
//
//            } else {//订单异常
//                if (mdata.getData().getDetail().getRefund().equals("0")) {
//                    if (mdata.getData().getDetail().getOrder_status().equals("2")) {//退款处理中
//                        mTvagain.setVisibility(View.VISIBLE);//在来一单
//                        stvFour.setVisibility(View.GONE);//客服
//                        stvThree.setVisibility(View.GONE);//取消订单
//                        stvTwo.setVisibility(View.GONE);//推单
...
//                    }
//
//                } else if (mdata.getData().getDetail().getRefund().equals("1")) {
//                    mTvagain.setVisibility(View.VISIBLE);//在来一单
//                    stvFour.setVisibility(View.GONE);//客服
//                    stvThree.setVisibility(View.GONE);//取消订单
//                    stvTwo.setVisibility(View.GONE);//推单
...
//                    rlStaffInfo.setVisibility(View.GONE);
//                }
//                if (mdata.getData().getDetail().getRefund().equals("2")) {//客服介入中
//                    mTvagain.setVisibility(View.VISIBLE);//在来一单
//                    stvFour.setVisibility(View.VISIBLE);//客服
//                    stvThree.setVisibility(View.GONE);//取消订单
//                    stvTwo.setVisibility(View.GONE);//推单
...
//                }
//
//                if (mdata.getData().getDetail().getRefund().equals("3")) {
//                    mTvagain.setVisibility(View.VISIBLE);//在来一单
//                    stvFour.setVisibility(View.GONE);//客服
//                    stvThree.setVisibility(View.GONE);//取消订单
//                    stvTwo.setVisibility(View.GONE);//推单
...
//        }
    ...
    public void onMapReady(GoogleMap map) {
        ...
        LatLng sydney = new LatLng(Double.parseDouble(staff.getLat()), Double.parseDouble(staff.getLng()));

        googleMap.addMarker(new MarkerOptions().position(sydney).icon(BitmapDescriptorFactory.fromResource(R.mipmap.icon_qishou)));
        MARKER = new CameraPosition.Builder().target(sydney)
                .zoom(15.5f)
                .bearing(0)/*地图旋转角度*/
                .tilt(50)
                .build();
    ...
    public View getInfoWindow(Marker marker) {
        ...
        googleMapRender(marker, infoWindow);
        return infoWindow;
    }
    ...
    private void googleMapRender(Marker marker, View infoWindow) {
        TextView snippet = (TextView) infoWindow.findViewById(R.id.snippet);
        int distance = (int)Double.parseDouble(SphericalUtil.computeDistanceBetween(new LatLng(userLatlng.latitude, userLatlng.longitude), new LatLng(Double.parseDouble(staff.getLat()), Double.parseDouble(staff.getLng()))) + "");
        String str = null;
        if (distance / 1000 > 0) {
            str = distance / 1000 + "." + (String.valueOf(distance % 1000).substring(0, 1)) + "km";
        } else {
        ...
        distanceInfo = "距" + ShopAnduser + "还有" + str;
        snippet.setText(distanceInfo);
        Intent i = new Intent();
        i.setClass(this, ShopMapActivityGMS.class);
        i.putExtra("lat", Double.parseDouble(staff.getLat()));
        i.putExtra("lng", Double.parseDouble(staff.getLng()));
        i.putExtra("title", getString(R.string.配送员位置));
        i.putExtra("address", distanceInfo);
