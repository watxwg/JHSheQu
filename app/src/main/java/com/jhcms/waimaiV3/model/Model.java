...
public class Model {
    ...
    // 第一个listview的文本数据数组
    public static String[] LEFTLISTVIEWTXT = new String[]{"热门分类", "美食", "购物",
            "休闲娱乐", "运动健身", "丽人", "结婚", "酒店", "爱车", "亲子", "生活服务", "家装"};
    // 第二个listview的文本数据
    public static String[][] RIGHTLISTTXT = {
    ...
    public static String[] LISTVIEWNUM = {"120", "20", "30", "40", "70", "80", "90", "50", "55", "66", "88", "50"};


    public static String[] FILTERPEI = {"不限", "平台送", "商家送"};
    public static String[] FILTERYOUHUI = {"首单优惠", "下单满减", "满返代金券", "进店领券"};
    public static String[] FILTERTESR = {"免配送费", "新店开业", "0元起送", "在线支付"};
