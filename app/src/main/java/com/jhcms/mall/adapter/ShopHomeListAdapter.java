...
public class ShopHomeListAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == HEADER_TYPE) {
            ...
            View view = inflater.inflate(R.layout.mall_list_item_shop_home_product, parent, false);
...
//            Log.e("=================", "onBindViewHolder: "+measuredWidth );
            ...
            normalViewHolder.tvProductPrice.setText(mContext.getString(R.string.￥2)+productItemModel.getWei_price());
            normalViewHolder.tvSaleNum.setText(mContext.getString(R.string.mall_已售f,productItemModel.getSales()));
            if (mListener != null) {
                normalViewHolder.itemView.setOnClickListener(v -> mListener.OnItemClickListener(productItemModel,position));
            }
        }
    }
