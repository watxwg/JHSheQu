...
public class PopLeftFenLeiAdapter extends RecyclerView.Adapter<PopLeftFenLeiAdapter.NormalViewHolder> {
    ...
    public PopLeftFenLeiAdapter(Context context, List<? extends CategoryInterface> data) {
    ...
    public NormalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.mall_list_item_pop_fenlei_left, parent, false);
