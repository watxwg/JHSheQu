...
public class ProductSingleAdapter extends RecyclerView.Adapter<ProductSingleAdapter.NormalViewHolder> {
    ...
    public ProductSingleAdapter(Context context, List<ProductItemModel> data) {
    ...
    public NormalViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = inflater.inflate(R.layout.mall_list_item_product_single, parent, false);
    ...
    public void onBindViewHolder(NormalViewHolder holder, int position) {
        ...
        ViewGroup.LayoutParams layoutParams = holder.ivProductLogo.getLayoutParams();
        layoutParams.height=layoutParams.width;
        holder.ivProductLogo.setLayoutParams(layoutParams);
