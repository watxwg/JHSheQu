...
public abstract class BottomTopBaseDialog<T extends BottomTopBaseDialog<T>> extends BaseDialog<T> {
    ...
    /** set duration for inner com.flyco.animationShow of mAnimateView(设置animateView内置动画时长) */
    ...
    /** show dialog and mAnimateView with inner show com.flyco.animationShow(设置dialog和animateView显示动画) */
    ...
    /** dimiss dialog and mAnimateView with inner dismiss com.flyco.animationShow(设置dialog和animateView消失动画) */
