...
public class DividerListItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private DividerListItemDecoration(int height, int lPadding, int rPadding, int colour) {
        mHeight = height;
        mLPadding = lPadding;
        mRPadding = rPadding;
        mPaint = new Paint();
    ...
    public static class Builder {
        ...
        /**
         * Instantiates a DividerListItemDecoration with the specified parameters.
         * @return a properly initialized DividerListItemDecoration instance
         */
        public DividerListItemDecoration build() {
            return new DividerListItemDecoration(mHeight, mLPadding, mRPadding, mColour);
        }
    }
}
