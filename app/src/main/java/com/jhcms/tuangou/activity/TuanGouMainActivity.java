...
import com.jhcms.tuangou.fragment.Group_HomeFragment;
import com.jhcms.tuangou.fragment.Group_MineFragment;
import com.jhcms.tuangou.fragment.Group_OrderFragment;
...
public class TuanGouMainActivity extends SwipeBaseActivity implements BottomNavigationView.OnNavigationItemSelectedListener {
    @Bind(R.id.content)
    FrameLayout content;
    @Bind(R.id.navigation)
    BottomNavigationView navigation;
    private Group_HomeFragment homeFragment;
    private Group_OrderFragment orderFragment;
    private Group_MineFragment mineFragment;
    ...
    private void initFragment() {
        homeFragment = new Group_HomeFragment();
        orderFragment = new Group_OrderFragment();
        mineFragment = new Group_MineFragment();
    ...
    protected void initView() {
        setContentView(R.layout.activity_tuan_gou_main);
        ...
        switch (item.getItemId()) {
            ...
            case R.id.tuan_order:
                if (TextUtils.isEmpty(Api.TOKEN)) {
                    isToLogin = true;
                    Intent intent = new Intent(TuanGouMainActivity.this, LoginActivity.class);
